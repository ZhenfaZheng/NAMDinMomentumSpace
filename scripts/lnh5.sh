...
npools=1 # No. of processes in each part of ephmat calculation.
nkparts=57 # No. of k-points in each part of ephmat calculation.
prefix='graphene'
pertpath="/data/zzf/graphene/pertexam_graphene/perturbo/ephmat/7_150x150K"
